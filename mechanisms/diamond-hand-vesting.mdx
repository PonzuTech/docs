...
While vesting, Ponzu Bottle holders also accumulate ETH from the Distributor. These come from the 1% swap fee for token sales. Fee is on the output token, so when someone sells TKN->ETH, the fee is in ETH, which gets sent to the distributor, of which part gets sent to the Presale claim.

Claim ETH whenever you want. This does not burn your Ponzu Bottle, nor does it count as your one-time token claim. You keep earning ETH from swap fees, even after vesting. No deadline.  
